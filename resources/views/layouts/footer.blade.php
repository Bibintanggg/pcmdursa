<footer id="kontak" class="bg-slate-900 text-slate-300 pt-12">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h4 class="text-white font-bold text-base">PCM Duren Sawit 1</h4>
                </div>
            ...
            <!-- LINK -->
            <div>
                <h5 class="text-white font-bold mb-3 text-sm">Tautan Cepat</h5>
                <ul class="space-y-2 text-slate-400 text-sm">
                    <li><a href="#profil" class="hover:text-white transition">› Profil Organisasi</a></li>
            ...
            <!-- CONTACT -->
            <div>
                <h5 class="text-white font-bold mb-3 text-sm">Hubungi Kami</h5>
        ...
        <!-- FOOTER BOTTOM -->
        <div class="border-t border-slate-700 mt-10 py-5 flex flex-col md:flex-row justify-between items-center gap-2 text-xs text-slate-500">
            <p>© 2026 PCM Duren Sawit 1. All rights reserved.</p>
            <div class="flex flex-wrap justify-center gap-3">
                <a href="#" class="hover:text-white transition">Kebijakan Privasi</a>
                <a href="#" class="hover:text-white transition">Syarat & Ketentuan</a>
                <span>Created by @bintang.ydha_</span>
            </div>
        </div>
