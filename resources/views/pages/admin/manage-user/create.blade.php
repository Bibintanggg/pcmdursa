                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="pw-wrap">
                                            ...
                                            <button type="button" class="pw-toggle" id="pw-toggle-btn" onclick="togglePassword()" title="Tampilkan/sembunyikan password">
                                                <!-- eye icon -->
                    ...
                    <div class="bg-white border border-gray-200 rounded-3xl overflow-hidden shadow-sm">
                        <div class="p-6">
                            ...
                            <div class="flex items-center gap-4 mb-5">
                                <div id="preview-avatar" class="w-14 h-14 rounded-2xl bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center text-xl font-bold text-gray-500 shrink-0 transition-all duration-300">
                                    ?
                                </div>
                                <div class="min-w-0">
                                    <h3 id="preview-name" class="text-lg font-semibold text-gray-900 truncate">Nama Akun</h3>
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center gap-3 p-3 rounded-xl bg-gray-50">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p id="preview-password" class="text-sm text-gray-700 font-medium tracking-widest">——</p>
                                    </div>
                                </div>
                            </div>
                        </div>
