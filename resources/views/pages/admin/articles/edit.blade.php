<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h2 class="text-xl font-bold text-gray-900" style="font-family:'DM Sans',sans-serif">Edit Artikel</h2>
            </div>
    ...
    <div class="min-h-screen bg-[#FAFAFA] dm py-10 px-4">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex items-center justify-between mb-8">
                <p class="text-sm text-gray-500">Ubah field yang diperlukan lalu simpan.</p>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <textarea name="content" rows="5" placeholder="Isi artikel..."
                                            class="field-input text-base text-gray-900 border-none py-1"
                                            oninput="sync('preview-content', this.value, 'Isi artikel akan tampil di sini...')">{{ old('content', $article->content) }}</textarea>
                                        @error('content')
                                            <p class="text-red-500 text-xs mt-1 font-medium">{{ $message }}</p>
                                        @enderror
                                    </div>
                        ...
                        <div class="grid grid-cols-12 lg:min-h-[220px]">
                            ...
                            <div class="col-span-12 lg:col-span-7 p-6 flex flex-col justify-center space-y-3 min-w-0">
                                ...
                                <p id="preview-content" class="text-neutral-600 text-sm line-clamp-3 break-all">
                                    {{ old('content', $article->content) ?: 'Isi artikel akan tampil di sini...' }}
                                </p>
    ...
    <script>
        ...
        // Initialize completion on load
        window.addEventListener('load', updateCompletion);
    </script>
