<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
                ...
                <div>
                    ...
                    <form action="{{ route($prefix . '.berita.update', $berita->id) }}" method="POST"
                        ...
                        <div class="space-y-4">
                                        ...
                                        <div id="kategoriBtn"
                                            ...
                                            <div class="flex items-center gap-2">
                                                <span id="kategori-dot"
                                                    class="w-2 h-2 rounded-full @if (old('kategori', $berita->kategori) == 'dakwah') bg-amber-500 @elseif(old('kategori', $berita->kategori) == 'pendidikan') bg-emerald-500 @elseif(old('kategori', $berita->kategori) == 'sosial') bg-sky-500 @elseif(old('kategori', $berita->kategori) == 'organisasi') bg-indigo-500 @else bg-gray-400 @endif"></span>
                                                <span id="kategori-label" class="text-sm font-medium">
                                                    @if (old('kategori', $berita->kategori) == 'dakwah')
                                                        Dakwah
                                                    @elseif(old('kategori', $berita->kategori) == 'pendidikan')
                                                        Pendidikan
                                                    @elseif(old('kategori', $berita->kategori) == 'sosial')
                                                        Sosial
                                                    @elseif(old('kategori', $berita->kategori) == 'organisasi')
                                                        Organisasi
                                                    @else
                                                        Pilih Kategori
                                                    @endif
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <input type="hidden" name="status" id="status"
                                            value="{{ old('status', $berita->status) }}">
                                        <div id="dropdownBtn"
                                            class="mt-2 flex items-center justify-between px-3 py-2 border rounded-xl cursor-pointer hover:border-black transition">
                                            <div class="flex items-center gap-2">
                                                <span id="dot"
                                                    class="w-2 h-2 rounded-full @if (old('status', $berita->status) == 'published') bg-emerald-500 @else bg-amber-500 @endif"></span>
                                                <span id="label" class="text-sm font-medium">
                                                    @if (old('status', $berita->status) == 'published')
                                                        Published
                                                    @else
                                                        Draft
                                                    @endif
                            ...
                            <div class="au d5">
                                <div class="flex items-center justify-between mb-2 px-1">
                                    ...
                                    <span class="text-xs text-gray-400">Opsional
                                        ({{ $berita->gambar ? 'Sudah ada' : 'Belum ada' }})</span>
                                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            sync('preview-content', document.querySelector('textarea[name="isi"]').value,
        ...
        function syncStatus(val) {
            ...
            if (val === 'published') {
                badge.className =
                    'inline-flex items-center gap-1 px-3 py-1.5 rounded-full text-xs font-medium bg-emerald-100 text-emerald-800 border border-emerald-200 shadow-sm';
                badge.textContent = 'Published';
            } else {
                badge.className =
                    'inline-flex items-center gap-1 px-3 py-1.5 rounded-full text-xs font-medium bg-amber-100 text-amber-800 border border-amber-200 shadow-sm';
        ...
        function syncKategori(val) {
            ...
            badge.className =
                `inline-flex items-center gap-1 px-3 py-1.5 rounded-full text-xs font-medium ${color.bg} shadow-sm`;
