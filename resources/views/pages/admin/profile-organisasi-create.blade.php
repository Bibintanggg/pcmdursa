        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex items-center justify-between mb-8">
                ...
                <div class="flex items-center gap-3 bg-black text-white text-sm font-semibold px-4 py-2 rounded-full">
                    ...
                    <span class="" id="completion-text">0% Lengkap</span>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
                ...
                {{-- ===== LEFT: FORM ===== --}}
                <div>
                    <form action="{{ route('admin.profile-organisasi.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="space-y-4">
                            ...
                            <div class="au d5">
                                ...
                                <label for="image-input" id="upload-zone"
                                    class="{{ !empty($profile->image ?? null) ? 'hidden' : '' }} flex flex-col items-center justify-center text-center cursor-pointer border-2 border-dashed border-gray-300 rounded-2xl bg-gray-50 py-10 px-6 transition-all duration-300 hover:border-black hover:bg-white hover:-translate-y-0.5">
